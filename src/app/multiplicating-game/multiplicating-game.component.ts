...
@Component({
  selector: 'app-multiplicating-game',
  templateUrl: './multiplicating-game.component.html',
  styleUrls: ['./multiplicating-game.component.scss']
})
export class MultiplicatingGameComponent {
userdetails: any;
  Answer: any;
  Wrong_ans: number = 0;
  Right_ans: number = 0;
